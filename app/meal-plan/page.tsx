  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="relative h-72 md:h-96 flex items-end">
        <Image src={IMAGES.hero3} alt="Meal Plan" fill priority
          className="object-cover object-center grayscale opacity-60" sizes="100vw" />
            ...
            <motion.div key="form"
              ...
              <div className="border-b border-white/10 pb-8 mb-10">
                ...
                <p className="text-white/35 text-sm leading-relaxed max-w-xl">
                  Tell us about yourself — including any allergies or dietary restrictions — and we&apos;ll recommend nutrition plans calibrated to your calorie needs and goals.
                </p>
              </div>
