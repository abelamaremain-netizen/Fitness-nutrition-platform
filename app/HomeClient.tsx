      ...
      <section className="py-28" style={{ background: "#111", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div className="max-w-6xl mx-auto px-8">
          <AnimatedSection className="text-center mb-16">
            ...
            <h2 style={{ fontFamily: "var(--font-serif)" }} className="text-4xl md:text-5xl font-bold text-white">
              How It <em>Works</em>
            </h2>
      ...
      <section className="py-28">
        <div className="max-w-6xl mx-auto px-8">
          <AnimatedSection className="flex items-end justify-between mb-12 flex-wrap gap-4">
            ...
            <Link href="/plans" className="flex items-center gap-2 text-[11px] tracking-[0.12em] uppercase text-white/40 hover:text-white transition-colors">
          ...
          {featured.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-white/30 text-sm">Plans coming soon.</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="py-28" style={{ background: "#111", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div className="max-w-6xl mx-auto px-8">
          ...
          {testimonials.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-white/30 text-sm">Testimonials coming soon.</p>
            </div>
          )}
