        ...
        <div className="absolute inset-0 flex flex-col justify-end p-12">
          <div className="card p-6 max-w-xs">
            <div className="flex gap-0.5 mb-3">
              {[1,2,3,4,5].map(i => <Star key={i} size={12} className="text-white/60 fill-white/60" />)}
            </div>
            ...
            <p className="text-white/40 text-xs font-semibold tracking-widest uppercase">— Selam T., Lost 12kg</p>
          </div>
        </div>
      </div>

      {/* Right: Form */}
      <div className="flex-1 flex items-center justify-center px-6 py-20 lg:max-w-md">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <p className="text-white/40 text-sm mb-9">Log in to access your purchased plans.</p>
          ...
          <p className="text-center text-white/30 text-sm mt-7">
            ...
            <Link href="/register" className="text-white hover:text-white/70 font-semibold transition-colors">
              Sign up
            </Link>
          </p>
        </motion.div>
